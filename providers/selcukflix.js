...
var require_normalize = __commonJS({
  "src/common/normalize.js"(exports2, module2) {
    ...
    function buildQueryVariants(metadata) {
      ...
      return uniqueStrings(queries).filter((value) => value.length >= 2).sort((left, right) => right.length - left.length).slice(0, 6);
    }
...
var require_tmdb = __commonJS({
  "src/common/tmdb.js"(exports2, module2) {
    ...
    var { uniqueStrings } = require_normalize();
    ...
    function resolveMetadata(tmdbId, mediaType, options) {
      ...
      return Promise.all(
        ...
        var uniqueTitles = uniqueStrings(titles);
...
// src/providers/selcukflix/index.js
      ...
      series.forEach(function(seasonBlock) {
        (seasonBlock.episodes || []).forEach(function(episode) {
          episodes.push({
            ...
            url: toAbsoluteUrl(episode.used_slug || "", baseUrl + "/"),
